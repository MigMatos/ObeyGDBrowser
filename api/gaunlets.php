...
$level = array_merge($level, [
    "id" => intval($result["ID"]),
    "levels" => [
        "name" => intval($result["name"]),
        "level1" => intval($result["level1"]),
        "level2" => intval($result["level2"]),
        "level3" => intval($result["level3"]),
        "level4" => intval($result["level4"]),
        "level5" => intval($result["level5"]),
    ],
    "levelsCount" => 5,  // Siempre hay 5 niveles, puedes cambiar esto si es necesario
]);
